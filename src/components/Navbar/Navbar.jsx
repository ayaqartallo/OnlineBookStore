                        ...
                        <ul className="items-center gap-4 hidden sm:flex">
                            {
                                Menu.map((item) => (
                                    <li>
                                        <a href={item.link} className="inline-block py-4 px-4 hover:text-primary duration-200">{item.name}</a>
                                    </li>
                                ))
                            }
                                ...
                                <ul>
                                    {
                                        DropdownLinks.map((data) => (
                                            <li key={data.id}><a href={data.link} className="inline-block w-full rounded-md p-2 hover:bg-primary/20 ">{data.name}</a></li>
                                        ))
                                    }
                                </ul>
                            </div>
